        ...
        with tf.variable_scope("seq2seq", dtype=dtype):
            with tf.variable_scope("encoder"):
                ...
                encoder_outputs, encoder_states = \
                    tf.nn.dynamic_rnn(encoder_fw_cell, encoder_inputs_emb,
