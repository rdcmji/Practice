...
MAX_KEEP = 1
cl_model_path = "class_model/"
cl_model_pattern = "class_model/{}.ckpt-{}"
...
if __name__ == "__main__":
    ...
    cl_ckpts = os.listdir(cl_model_path)
    models = []
    for item in ckpts:
        toks = item.split('.')
        if len(toks) != 3:
    ...
    for model in models:
        cl_ckpt = cl_model_pattern.format('class_model', '5000')
